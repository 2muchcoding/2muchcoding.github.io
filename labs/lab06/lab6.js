...
$(document).ready(function () {
    ...
    $('#nameHeading').click(function() {
        ...
        $('#nameHeading .myName').text('Anoua Carrie')
            .css('color', 'red')
            .css('font-variant', 'red')
    ...
    function updateGallery() {
        $('#galleryImage').attr('src', galleryImages[currentImage]);
    }
    ...
    // Open the clicked one (only if not already visible)
